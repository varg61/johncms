<div class="phdr"><h3><?=$this->lng['banned_contacts']?></h3></div>
...
<?if($this->total):?>
	...
	<input type="submit" name="unban" value="<?=$this->lng['unban']?>"/> <input type="submit" name="delete" value="<?=Vars::$LNG['delete']?>"/><br />
	</div>
	</div></form>
