...
class Fields
{
    private $elements = array(
        ...
        'text'         => array('<input%s%s type="text" value="%s"%s%s%s%s/>', 'id,name,value,class,style,maxlength,required'),
        'textarea'     => array('<textarea%s%s%s%s%s%s>%s</textarea>', 'id,name,rows,class,style,required,value'),
    );
