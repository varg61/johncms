...
//TODO: Написать новый поиск для библиотеки
...
if ($g > 10) {
    ...
    if ($page > 13) {
        echo ' <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh . '&amp;page=' . $paa . '">' . $paa . '</a> <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh . '&amp;page=' . ($paa + 1) . '">'
            . ($paa + 1) . '</a> .. <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh . '&amp;page=' . ($paa * 2) . '">' . ($paa * 2) . '</a> <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh
            . '&amp;page=' . ($paa * 2 + 1) . '">' . ($paa * 2 + 1) . '</a> .. ';
    } elseif ($page > 7) {
    ...
    if ($page2 > 12) {
        echo ' .. <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh . '&amp;page=' . $paa2 . '">' . $paa2 . '</a> <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh . '&amp;page=' . ($paa2 + 1) . '">'
            . ($paa2 + 1) . '</a> .. <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh . '&amp;page=' . ($paa3) . '">' . ($paa3) . '</a> <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh . '&amp;page='
            . ($paa3 + 1) .
            '">' . ($paa3 + 1) . '</a> ';
    } elseif ($page2 > 6) {
        echo ' .. <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh . '&amp;page=' . $pa2 . '">' . $pa2 . '</a> <a href="index.php?act=search&amp;mod=' . $mod . '&amp;srh=' . $srh . '&amp;page=' . ($pa2 + 1) . '">'
            . ($pa2 + 1) . '</a> ';
    }
    if ($asd2 < $g) {
