...
switch ($_GET['act'])
{
    case 'set':
        ...
        if (empty($error))
        {
            ...
            echo '<hr /><p>При желании, Вы можете установить ДЕМО данные<br />Это может быть полезно для начинающих сайтостроителей. В базу будут внесены некоторые исходные настроики и материалы.</p>';
