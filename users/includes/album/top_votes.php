...
-----------------------------------------------------------------
*/
echo '<div class="phdr"><a href="album.php"><b>' . $lng['photo_albums'] . '</b></a> | ' . $lng_profile['top_votes'] . '</div>';
...
if ($total) {
    if ($total > $kmess)
        echo '<div class="topmenu">' . functions::display_pagination('album.php?act=top_votes&amp;', $start, $total, $kmess) . '</div>';
...
if ($total > $kmess) {
    echo '<div class="topmenu">' . functions::display_pagination('album.php?act=top_votes&amp;', $start, $total, $kmess) . '</div>' .
        '<p><form action="album.php?act=top_votes" method="post">' .
