...
/*
-----------------------------------------------------------------
Топ фотографий с худшим рейтингом
-----------------------------------------------------------------
*/
echo '<div class="phdr"><a href="album.php"><b>' . $lng['photo_albums'] . '</b></a> | ' . $lng_profile['top_trash'] . '</div>';
...
if ($total) {
    if ($total > $kmess)
        echo '<div class="topmenu">' . functions::display_pagination('album.php?act=top_trash&amp;', $start, $total, $kmess) . '</div>';
...
if ($total > $kmess) {
    echo '<div class="topmenu">' . functions::display_pagination('album.php?act=top_trash&amp;', $start, $total, $kmess) . '</div>' .
        '<p><form action="album.php?act=top_trash" method="post">' .
