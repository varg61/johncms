...
echo '<li><span class="gray">' . $lng_profile['name'] . ':</span> ' . (empty($user['imname']) ? '' : $user['imname']) . '</li>' .
    ...
    '<li><span class="gray">' . $lng_profile['about'] . ':</span> ' . (empty($user['about']) ? '' : '<br />' . functions::smileys(functions::tags($user['about']))) . '</li>' .
    '</ul></p><p>' .
...
echo '</li>' .
    ...
    '<li><span class="gray">' . $lng_profile['site'] . ':</span> ' . (empty($user['www']) ? '' : functions::tags($user['www'])) . '</li>' .
    '</ul></p></div>' .
