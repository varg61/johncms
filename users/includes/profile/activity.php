        ...
        if (mysql_num_rows($req)) {
            ...
            while ($res = mysql_fetch_assoc($req)) {
                ...
                echo ($i % 2 ? '<div class="list2">' : '<div class="list1">') .
                     '<a href="' . Vars::$SYSTEM_SET['homeurl'] . '/forum/index.php?id=' . $res['id'] . '">' . $res['text'] . '</a>' .
                     '<br />' . $text . '...<a href="' . Vars::$SYSTEM_SET['homeurl'] . '/forum/index.php?id=' . $res['id'] . '"> &gt;&gt;</a>' .
                     '<div class="sub">' .
                     '<a href="' . Vars::$SYSTEM_SET['homeurl'] . '/forum/index.php?id=' . $category['id'] . '">' . $category['text'] . '</a> | ' .
                     '<a href="' . Vars::$SYSTEM_SET['homeurl'] . '/forum/index.php?id=' . $section['id'] . '">' . $section['text'] . '</a>' .
        ...
        */
        ...
        if (mysql_num_rows($req)) {
            ...
            while ($res = mysql_fetch_assoc($req)) {
                ...
                echo ($i % 2 ? '<div class="list2">' : '<div class="list1">') .
                     '<a href="' . Vars::$SYSTEM_SET['homeurl'] . '/forum/index.php?id=' . $topic['id'] . '">' . $topic['text'] . '</a>' .
                     '<br />' . $text . '...<a href="' . Vars::$SYSTEM_SET['homeurl'] . '/forum/index.php?act=post&amp;id=' . $res['id'] . '"> &gt;&gt;</a>' .
                     '<div class="sub">' .
                     '<a href="' . Vars::$SYSTEM_SET['homeurl'] . '/forum/index.php?id=' . $category['id'] . '">' . $category['text'] . '</a> | ' .
                     '<a href="' . Vars::$SYSTEM_SET['homeurl'] . '/forum/index.php?id=' . $section['id'] . '">' . $section['text'] . '</a>' .
                     '<br /><span class="gray">(' . Functions::displayDate($res['time']) . ')</span>' .
