...
$menu = array (
    ...
    ($mod == 'chat' ? '<b>' . $lng['chat'] . '</b>' : '<a href="profile.php?act=settings&amp;mod=chat">' . $lng['chat'] . '</a>'),
);
...
switch ($mod) {
    ...
    case 'chat':
        ...
        */
        ...
        echo '<form action="profile.php?act=settings&amp;mod=chat" method="post">' .
            '<div class="menu"><p><h3>' . $lng_set['main_settings'] . '</h3>' .
            '<input type="text" name="refresh" size="2" maxlength="2" value="' . $set_chat['refresh'] . '"/> ' . $lng_set['chat_refresh'] . '<br />' .
            '<input type="text" name="chmes" size="2" maxlength="2" value="' . $set_chat['chmes'] . '"/> ' . $lng_set['chat_msg_per_page'] . '<br />' .
        ...
        echo '</p><p><input type="submit" name="submit" value="' . $lng['save'] . '"/></p></div></form>' .
            '<div class="phdr"><a href="profile.php?act=settings&amp;mod=chat&amp;reset">' . $lng['reset_settings'] . '</a></div>' .
            '<p><a href="../chat/index.php">' . $lng['to_chat'] . '</a></p>';
        break;
