...
echo '<div class="phdr"><b>' . $lng_profile['my_office'] . '</b></div>' .
    ...
    '</p><p>' .
    '<div><img src="' . $home . '/images/photo.gif" width="16" height="16"/>&#160;<a href="../album/index.php?act=catalogue">' . $lng['photo_album'] . '</a>&#160;(' . $total_photo . ')</div>' .
...
echo '<h3><img src="' . $home . '/images/mail.png" width="16" height="16" class="left" />&#160;' . $lng_profile['my_mail'] . '</h3><ul>' .
...
echo '</ul><h3><img src="' . $home . '/images/users.png" width="16" height="16" class="left" />&#160;' . $lng['contacts'] . '</h3><ul>' .
