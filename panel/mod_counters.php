    ...
    case 'view':
        ...
        if ($id) {
            ...
            if (mysql_num_rows($req)) {
                ...
                echo '</p></div>';
                echo '<div class="phdr">'
                    . ($res['switch'] == 1 ? '<a href="index.php?act=mod_counters&amp;mod=view&amp;go=off&amp;id=' . $id . '">Выключить</a>' : '<a href="index.php?act=mod_counters&amp;mod=view&amp;go=on&amp;id=' . $id . '">Включить</a>')
                        . ' | <a href="index.php?act=mod_counters&amp;mod=edit&amp;id=' . $id . '">Изм.</a> | <a href="index.php?act=mod_counters&amp;mod=del&amp;id=' . $id . '">Удалить</a></div>';
            } else {
