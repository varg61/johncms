...
switch ($sort) {
    case 'nick':
        $sort = 'nick';
        echo '<a href="index.php?act=usr_list&amp;sort=id">ID</a> | ' . $lng['nick'] . ' | <a href="index.php?act=usr_list&amp;sort=ip">IP</a></div>';
        $order = '`name` ASC';
        break;

    case 'ip':
        $sort = 'ip';
        echo '<a href="index.php?act=usr_list&amp;sort=id">ID</a> | <a href="index.php?act=usr_list&amp;sort=nick">' . $lng['nick'] . '</a> | IP</div>';
        $order = '`ip` ASC';
        break;
        default :
    $sort = 'id';
        echo 'ID | <a href="index.php?act=usr_list&amp;sort=nick">' . $lng['nick'] . '</a> | <a href="index.php?act=usr_list&amp;sort=ip">IP</a></div>';
        $order = '`id` ASC';
}
