...
echo '<div class="menu"><p>' .
     '<h3>' . functions::get_image($color[$set['mod_forum']] . '.png', '', 'class="left"') . '&#160;' . $lng['forum'] . '</h3>' .
...
-----------------------------------------------------------------
*/
echo '<p><h3>' . functions::get_image($color[$set['mod_guest']] . '.png', '', 'class="left"') . '&#160;' . $lng['guestbook'] . '</h3>' .
     '<div style="font-size: x-small">' .
...
-----------------------------------------------------------------
*/
echo '<p><h3>' . functions::get_image($color[$set['mod_lib']] . '.png', '', 'class="left"') . '&#160;' . $lng['library'] . '</h3>' .
     '<div style="font-size: x-small">' .
...
-----------------------------------------------------------------
*/
echo '<p><h3>' . functions::get_image($color[$set['mod_gal']] . '.png', '', 'class="left"') . '&#160;' . $lng['gallery'] . '</h3>' .
     '<div style="font-size: x-small">' .
...
-----------------------------------------------------------------
*/
echo '<p><h3>' . functions::get_image($color[$set['mod_down']] . '.png', '', 'class="left"') . '&#160;' . $lng['downloads'] . '</h3>' .
     '<div style="font-size: x-small">' .
...
-----------------------------------------------------------------
*/
echo '<p><h3>' . functions::get_image($color[$set['active'] + 1] . '.png', '', 'class="left"') . '&#160;' . $lng['community'] . '</h3>' .
     '<div style="font-size: x-small">' .
...
-----------------------------------------------------------------
*/
echo '<div class="gmenu"><h3>' . functions::get_image($color[$set['mod_reg']] . '.png', '', 'class="left"') . '&#160;' . $lng['registration'] . '</h3>' .
     '<div style="font-size: x-small">' .
