        ...
        */
        ...
        if ($total) {
            ...
            echo '<div class="rmenu"><input type="submit" value="' . $lng['delete'] . '"/></div></form>' .
                 '<div class="gmenu"><form name="form" action="?act=languages&amp;mod=add_phrase&amp;language=' . $language . '&amp;module=' . $name_module . '&amp;start=' . $start . '" method="POST">' .
        ...
        */
        ...
        if (isset($_POST['submit']) && !empty($_POST['key']) && !empty($_POST['value'])) {
            ...
            if (!$key || !$value || in_array($key, array_keys($lng_module))) {
                header('Location: index.php?act=languages&mod=add_phrase&language=' . $language . '&module=' . $name_module . '&start=' . $start . '&do=no_key');
                exit;
            }
