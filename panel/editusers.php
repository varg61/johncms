...
if ($dostadm == 1)
{
    ...
    $qus = mysql_query("SELECT * FROM `users` WHERE `id` = " . abs(intval($_GET['user'])));
    ...
    switch ($act)
    {
        ...
        case "edit":
            ...
            echo '</div><div class="menu">О себе:<br /><textarea cols="20" rows="4" name="about">' . $arr1['about'] . '</textarea></div>';
