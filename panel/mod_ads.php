...
switch ($from) {
    ...
    case 'edit':
        ...
        if (isset($_POST['submit'])) {
            ...
            <b>Название:</b><br />
            <input type="text" name="name" value="' . htmlentities($arr['name'], ENT_QUOTES, 'UTF-8') . '"/><br />
            <small>Для смены названия при обновление страницы перечислите все названия через знак "|".</small><br />
            <b>Цвет:</b><br /><input type="text" name="color" value="' . $arr['color'] . '"/><br />
            <small>В формате FFFFFF, если не хотите выделять ссылку цветом, то просто не заполняйте это поле.</small><br />
            <b>Переходы:</b><br /><input type="text" name="count"  value="' . $arr['count_link'] . '"/><br />
            <small>Колличество переходов, после котого ссылка автоматически уберется. 0 - без ограничей.</small><br />
            <b>Дни:</b><br /><input type="text" name="day"  value="' . $arr['day'] . '"/><br />
            <small>Колличество дней с момента установки ссылки, поистечению которого ссылка автоматически уберется. 0 - без ограничей.</small><br />
            <b>Место:</b><input type="text" name="mesto" size="2" value="' . $arr['mesto'] . '"/><br />
            <small>Если оставить пустым, то сылка будет добавлена в конец списка.</small>
            </div><div class="gmenu"><b>Показывать:</b><br />
            <input type="radio" name="type" value="0" ' . ($arr['type'] == 0 ? 'checked="checked"' : '') . '/> Над логотипом<br />
            <input type="radio" name="type" value="1" ' . ($arr['type'] == 1 ? 'checked="checked"' : '') . '/> Под меню юзера<br />
            <input type="radio" name="type" value="2" ' . ($arr['type'] == 2 ? 'checked="checked"' : '') . '/> Над счетчиками<br />
            <input type="radio" name="type" value="3" ' . ($arr['type'] == 3 ? 'checked="checked"' : '') . '/> Под счетчиками<br />
            <b>Размещение:</b><br />
            <input type="radio" name="layout" value="0" ' . ($arr['layout'] == 0 ? 'checked="checked"' : '') . '/> На всех страницах<br />
            <input type="radio" name="layout" value="1"  ' . ($arr['layout'] == 1 ? 'checked="checked"' : '') . '/> Только на главной<br />
            <input type="radio" name="layout" value="2"  ' . ($arr['layout'] == 2 ? 'checked="checked"' : '') . '/> На всех, кроме главной<br />
            <b>Выделение:</b><br />
            <input type="checkbox" name="font_1" ' . ($arr['font'] == 2 || $arr['font'] == 5 || $arr['font'] == 6 || $arr['font'] == 9 ? 'checked="checked"' : '') . '/> <b>Жирный</b><br />
            <input type="checkbox" name="font_2" ' . ($arr['font'] == 3 || $arr['font'] == 5 || $arr['font'] == 7 || $arr['font'] == 9 ? 'checked="checked"' : '') . '/>  <i>Наклонный</i><br />
            <input type="checkbox" name="font_3"  ' . ($arr['font'] == 4 || $arr['font'] == 7 || $arr['font'] == 6 || $arr['font'] == 9 ? 'checked="checked"' : '') . '/>  <u>Подчеркнутый</u>
            </div><div class="phdr">
    ...
    case 'addlink':
        if (isset($_POST['submit'])) {
            ...
            echo '<div class="phdr"><b>Добавление ссылки</b></div><form action="index.php?act=mod_ads&amp;from=addlink" method="post"><div class="menu">
            <b>Ссылка:</b><br />
            <input type="text" name="link" value="http://"/><br /><b>Название:</b><br />
            ...
            <b>Цвет:</b><br /><input type="text" name="color"/><br /><small>В формате FFFFFF, если не хотите выделять ссылку цветом, то просто не заполняйте это поле.</small><br />
            <b>Переходы:</b><br /><input type="text" name="count" value="0"/><br /><small>Колличество переходов, после котого ссылка автоматически уберется. 0 - без ограничей.</small><br />
            <b>Дни:</b><br /><input type="text" name="day" value="0"/><br /><small>Колличество дней с момента установки ссылки, поистечению которого ссылка автоматически уберется. 0 - без ограничей.</small><br />
            <b>Место:</b><input type="text" name="mesto" size="2"/><br /><small>Если оставить пустым, то сылка будет добавлена в конец списка.</small>
            </div><div class="gmenu"><b>Показывать:</b><br /><input type="radio" name="view" value="0" checked="checked"/> Всем<br />
            ...
            <b>Размещение:</b><br /><input type="radio" name="layout" value="0" checked="checked"/> На всех страницах<br />
            <input type="radio" name="layout" value="1" /> Только на главной<br />
            <input type="radio" name="layout" value="2" /> На всех, кроме главной<br />
            <b>Выделение:</b><br /><input type="checkbox" name="font_1"/> <b>Жирный</b><br />
    ...
    case 'active':
        ...
        switch ($sort) {
            case '3':
                echo '<a href="index.php?act=mod_ads&amp;from=active&amp;up_1">Над логотипом</a> | <a href="index.php?act=mod_ads&amp;from=active&amp;up_2">Под меню юзера</a> | <a href="index.php?act=mod_ads&amp;from=active&amp;down_2">Над счетчиками</a> | Под счетчиками';
                break;

            case '2':
                echo '<a href="index.php?act=mod_ads&amp;from=active&amp;up_1">Над логотипом</a> | <a href="index.php?act=mod_ads&amp;from=active&amp;up_2">Под меню юзера</a>
       | Над счетчиками | <a href="index.php?act=mod_ads&amp;from=active&amp;down_1">Под счетчиками</a>';
                break;

            case '1':
                echo '<a href="index.php?act=mod_ads&amp;from=active&amp;up_1">Над логотипом</a> | Под меню юзера
       ...
       | <a href="index.php?act=mod_ads&amp;from=active&amp;down_2">Над счетчиками</a> | <a href="index.php?act=mod_ads&amp;from=active&amp;down_1">Под счетчиками</a>';
            ...
            default:
                echo 'Над логотипом | <a href="index.php?act=mod_ads&amp;from=active&amp;up_2">Под меню юзера</a>
       | <a href="index.php?act=mod_ads&amp;from=active&amp;down_2">Над счетчиками</a> | <a href="index.php?act=mod_ads&amp;from=active&amp;down_1">Под счетчиками</a>';
        }
        ...
        if ($total > 0) {
            ...
            while ($arr = mysql_fetch_array($req)) {
                ...
                echo ' <br /><small><a href="index.php?act=mod_ads&amp;from=edit&amp;id=' . $arr['id'] . '">Изм.</a> | <a href="index.php?act=mod_ads&amp;from=del&amp;id=' . $arr['id']
                    . '">Удал.</a> | <a href="index.php?act=mod_ads&amp;from=to&amp;id=' . $arr['id'] .
                    '">Скрыть</a>';
    ...
    case 'noactive':
        if (isset($_GET['down_1']))
            $_SESSION['abs_link'] = 3;
        else if (isset($_GET['down_2']))
            $_SESSION['abs_link'] = 2;
        else if (isset($_GET['up_2']))
            $_SESSION['abs_link'] = 1;
        else if (isset($_GET['up_1']))
            $_SESSION['abs_link'] = 0;
        echo '<div class="phdr"><b>Активные ссылки</b></div><div class="bmenu">';
        $sort = $_SESSION['abs_link'] ? intval($_SESSION['abs_link']) : 0;
        switch ($sort) {
            ...
            case '2':
                echo '<a href="index.php?act=mod_ads&amp;from=noactive&amp;up_1">Над логотипом</a> | <a href="index.php?act=mod_ads&amp;from=noactive&amp;up_2">Под меню юзера</a>
                | Над счетчиками | <a href="index.php?act=mod_ads&amp;from=noactive&amp;down_1">Под счетчиками</a>';
                break;

            case '1':
                echo '<a href="index.php?act=mod_ads&amp;from=noactive&amp;up_1">Над логотипом</a> | Под меню юзера
       ...
       | <a href="index.php?act=mod_ads&amp;from=noactive&amp;down_2">Над счетчиками</a> | <a href="index.php?act=mod_ads&amp;from=noactive&amp;down_1">Под счетчиками</a>';
            ...
            default:
                echo 'Над логотипом | <a href="index.php?act=mod_ads&amp;from=noactive&amp;up_2">Под меню юзера</a>
       | <a href="index.php?act=mod_ads&amp;from=noactive&amp;down_2">Над счетчиками</a> | <a href="index.php?act=mod_ads&amp;from=noactive&amp;down_1">Под счетчиками</a>';
        }
        echo '</div><div class="gmenu"><a href="index.php?act=mod_ads&amp;from=addlink">Добавить ссылку</a></div>';
        ...
        if ($total > 0) {
            ...
            while ($arr = mysql_fetch_array($req)) {
                ...
                echo '<a href="index.php?act=mod_ads&amp;from=view&amp;id=' . $arr['id'] . '">' . $name . '</a>';
                echo ' <br /><small><a href="index.php?act=mod_ads&amp;from=edit&amp;id=' . $arr['id'] . '">Изм.</a> | <a href="index.php?act=mod_ads&amp;from=del&amp;id=' . $arr['id']
                    . '">Удал.</a> | <a href="index.php?act=mod_ads&amp;from=recovery&amp;id=' . $arr['id'] .
                    '">Вост.</a>';
                echo ' | <a href="index.php?act=mod_ads&amp;from=up&amp;id=' . $arr['id'] . '">Вверх</a> | <a href="index.php?act=mod_ads&amp;from=down&amp;id=' . $arr['id'] . '">Вниз</a></small>';
                echo '</div>';
                ++$i;
        ...
        if ($total > $kmess) {
            //TODO: Исправить навигацию
            echo '<p>' . display_pagination('index.php?from=noactive&amp;', $start, $total, $kmess) . '</p>';
