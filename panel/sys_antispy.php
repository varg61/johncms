...
class scaner {
    ...
    '../panel/mod_forum.php', '../panel/sys_set.php', '../incfiles/class_upload.php', '../str/my_images.php', '../str/redirect.php', '../panel/mod_ads.php', '../str/avatar.php', '../forum/thumbinal.php');
