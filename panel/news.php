...
if (!empty($set['news']))
{
    if (isset($_POST['submit']))
    {
        ...
        $settings = array('view' => $view, 'size' => $size, 'quantity' => $quantity, 'days' => $days, 'breaks' => $breaks, 'smileys' => $smileys, 'tags' => $tags);
    ...
    } else
    {
        ...
        echo '<input name="tags" type="checkbox" value="1" ' . ($settings['tags'] ? 'checked="checked"' : '') . ' />&nbsp;Тэги (BBcode)</p></div>';
...
{
    $settings = serialize(array('view' => '1', 'size' => '200', 'quantity' => '5', 'days' => '3', 'breaks' => '0', 'smileys' => '0', 'tags' => '0'));
