...
echo
'<title>JohnCMS 3.1.0 - обновление</title>
<style type="text/css">
...
switch ($do) {
    ...
    case 'step2' :
        ...
        // Настройки системы
        $newarr = array('karma_points' => '5', 'karma_time' => '86400', 'forum' => '20', 'time' => '0', 'on' => '1');
    ...
    default :
        ...
        echo '<li>Учтите, что обновление возможно только для оригинальной (без модов) системы <b>JohnCMS 3.0.0</b><br />Если Вы используете какие-либо моды, то возможность обновления обязательно согласуйте с их авторами.<br />Установка данного обновления на модифицированную систему может привести к полной неработоспособности сайта.</li>';
