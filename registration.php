...
else
{
    if ($set['rmod'] == 1)
    {
        echo '<p>В данный момент на сайте включена премодерация.<br/>Вы сможете получить авторизованный доступ к разделам сайта после подтверждения Вашей регистрации.</p>';
    }
    regform();
}
