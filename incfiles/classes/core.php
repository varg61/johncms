...
class core
{
    ...
    */
    private function lng_detect()
    {
        ...
        if (!empty($setlng) && array_key_exists($setlng, $this->lng_list)) $_SESSION['lng'] = $setlng;
        if (isset($_SESSION['lng']) && array_key_exists($_SESSION['lng'], $this->lng_list)) $this->lng = $_SESSION['lng'];
        elseif ($this->user_id && isset($this->user_set['lng']) && array_key_exists($this->user_set['lng'], $this->lng_list)) $this->lng = $this->user_set['lng'];
