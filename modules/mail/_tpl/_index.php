...
<div class="topmenu"><a href="<?php echo Vars::$MODULE_URI ?>?act=contacts"><?php echo lng( 'contacts' ) ?></a></div>
<div class="list1">
<p>
...
<div class="gmenu"><?php echo lng( 'receive_mail' ) ?>:&#160;<a href="<?php Vars::$MODULE_URI ?>?act=settings"><?php echo $this->receive_mail ?></a></div>
<div class="list2">
<p>
