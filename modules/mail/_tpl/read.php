<p>
    <a href="<?= Vars::$MODULE_URI ?>?act=messages&amp;id=<?= $this->user_id ?>"><?= __('answer') ?></a>
</p>
...
<div class="phdr"><a href="<?= Vars::$MODULE_URI ?>?act=<?= $this->back ?>"><?= __('back') ?></a></div>
<p>
<div class="func">
    <a href="<?= Vars::$MODULE_URI ?>?act=send&amp;id=<?= Vars::$ID ?>">Переслать</a><br/>
    <?php if ($this->read == 0 && $this->users_id == Vars::$USER_ID): ?>
    <a href="<?= Vars::$MODULE_URI ?>?act=edit&amp;id=<?= Vars::$ID ?>"><?= __('edit') ?></a><br/>
    <? endif ?>
    <a href="<?= Vars::$MODULE_URI ?>?act=messages&amp;mod=delete&amp;id=<?= Vars::$ID ?>"><?= __('delete') ?></a><br/>
</div>
</p>
<p>
