<p><a href="<?= Vars::$MODULE_URI ?>?act=add"><?= __('write_message') ?></a></p>
<div class="phdr"><strong><?= __('contacts') ?></strong></div>
<div class="topmenu"><a href="<?= Vars::$MODULE_URI ?>"><?= __('mail') ?></a></div>
<?php if ($this->total): ?>
<div>
...
<?php endif ?>
<div class="list2">
    <?= Functions::getImage('mail-friends.png') ?> <a href="<?= Vars::$HOME_URL ?>/friends"><?= __('friends') ?></a>&#160;(<?= $this->friends ?>)<br/>
