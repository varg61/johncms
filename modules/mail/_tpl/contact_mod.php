...
<div class="topmenu"><a href="<?php echo Vars::$MODULE_URI ?>"><?php echo lng( 'mail' ) ?></a></div>
<?php if($this->total): ?>
<div><form action="<?php echo Vars::$MODULE_URI ?>?act=contacts" method="post">
...
<?php endif ?>
<div class="list2">
<?php echo Functions::getImage('mail-friends.png') ?> <a href="<?php echo Vars::$HOME_URL ?>/friends"><?php echo lng( 'friends' ) ?></a>&#160;(<?php echo $this->friends ?>)<br />
