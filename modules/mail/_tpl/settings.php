...
<div class="form-container">
    <form name="form" action="<?= Vars::$MODULE_URI ?>?act=settings" method="post">
        <div class="form-block">
            ...
            <input type="radio" name="access" value="2" <?= ($this->access == 2 ? 'checked="checked"' : '') ?> id="only_friends"/> <label for="only_friends"><?= lng('only_friends') ?></label><br/>
