...
<div class="toolbar-top">
    ...
    <a class="btn<?= Vars::$ACT == 'history' ? '' : ' btn-primary' ?> btn-mini" href="<?= Vars::$URI ?>?act=history"><?= lng('history') ?></a>
    <?php endif ?>
    <?php if (Vars::$USER_RIGHTS): ?>
    <a class="btn<?= Vars::$ACT == 'guest' ? '' : ' btn-primary' ?> btn-mini" href="<?= Vars::$URI ?>?act=guest"><?= lng('guests') ?></a>
