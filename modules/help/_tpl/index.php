<ul class="nav">
    ...
    <li><a href="<?= Router::getUrl(2) ?>tags/"><i class="icn-info"></i><?= __('tags') ?><i class="icn-arrow right"></i></a></li>
    <li><a href="<?= Vars::$HOME_URL ?>avatars/"><i class="icn-image"></i><?= __('avatars') ?><i class="icn-arrow right"></i></a></li>
    <li><a href="<?= Vars::$HOME_URL ?>smilies/"><i class="icn-smile"></i><?= __('smileys') ?><i class="icn-arrow right"></i></a></li>
