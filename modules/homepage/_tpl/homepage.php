<ul class="nav">
    ...
    <li><a href="<?= Vars::$HOME_URL ?>/users"><i class="icn-man-woman"></i><?= __('users') ?><i class="icn-arrow"></i><span class="badge badge-right">0</span></a></li>
    <li><a href="<?= Vars::$HOME_URL ?>/album"><i class="icn-image"></i><?= __('photo_albums') ?><i class="icn-arrow"></i><span class="badge badge-right">0</span></a></li>
</ul>