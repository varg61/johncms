...
switch ($reg_step) {
    case 2:
        $tpl->contents = $tpl->includeTpl('registration_confirm');
        break;
    ...
    default:
        ...
        */
        ...
        $reg_data['login'] = isset($_POST['reg_login']) ? trim($_POST['reg_login']) : '';
        $reg_data['password'] = isset($_POST['reg_password']) ? mb_substr(trim($_POST['reg_password']), 0, 50) : '';
        ...
        $tpl->contents = $tpl->includeTpl('registration_form');
}