...
<div class="form-container">
    ...
    <form action="<?= Router::getUrl(3) ?>?act=avatar_delete&amp;user=<?= $this->user['id'] ?>" method="post">
        <div class="form-block align-center">
            ...
            <a class="btn" href="<?= Router::getUrl(3) ?>?act=settings&amp;user=<?= $this->user['id'] ?>"><?= __('cancel') ?></a>
