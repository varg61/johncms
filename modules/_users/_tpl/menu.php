...
<ul class="nav">
    ...
    <li><a href="<?= Vars::$HOME_URL ?>guestbook/?mod=adm" class="red"><i class="icn-dialogue-red"></i><?= __('admin_club') ?><i class="icn-arrow"></i><span class="badge badge-red badge-right"><?= $this->count->adminclub ?></span></a></li>
    <li><a href="<?= Vars::$HOME_URL ?>admin/" class="red"><i class="icn-shield-red"></i><?= __('admin_panel') ?><i class="icn-arrow"></i></a></li>
    <?php endif ?>

    <li><h2><?= __('control') ?></h2></li>
