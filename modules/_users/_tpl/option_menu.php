...
<ul class="nav">
    ...
    <li><a href="<?= $this->uri ?>avatar/"><i class="icn-upload"></i><?= __('upload_avatar') ?><i class="icn-arrow"></i></a></li>
    <?php endif ?>
    ...
    <li><a href="<?= $this->uri ?>rights/"><i class="icn-shield-red"></i><?= __('rank') ?><i class="icn-arrow"></i></a></li>
    <?php endif ?>
    <li><a href="<?= $this->uri ?>password/"><i class="icn-shield"></i><?= __('change_password') ?><i class="icn-arrow"></i></a></li>
    <?php if (Vars::$USER_SYS['change_nickname'] || Vars::$USER_RIGHTS >= 7): ?>
    <li><a href="<?= $this->uri ?>nickname/"><i class="icn-shield"></i><?= __('change_nickname') ?><i class="icn-arrow"></i></a></li>
    <?php endif ?>
</ul>