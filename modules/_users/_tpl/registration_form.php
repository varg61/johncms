...
<div class="form-container">
    ...
    <div class="form-block">
        <form action="<?= Vars::$URI ?>" method="post">
            ...
            <span class="input-help success"><?= lng('nick_available') ?></span><br/>
            <?php endif ?>
            ...
            <input class="btn" type="submit" name="check_login" value="?"/>
            ...
            <ul style="list-style: none; padding-left: 0">
                <li><input id="sex" type="radio" value="1" name="sex" <?= ($this->reg_data['sex'] == 1 ? 'checked="checked"' : '') ?>/>&#160;<?= Functions::loadImage('user.png') ?>&#160;<?= lng('sex_m') ?></li>
                <li><input type="radio" value="2" name="sex" <?= ($this->reg_data['sex'] == 2 ? 'checked="checked"' : '') ?>/>&#160;<?= Functions::loadImage('user-female.png') ?>&#160;<?= lng('sex_w') ?></li>
            </ul>
            ...
            <br/><label for="captcha"><?= lng('captcha') ?></label><br/>
            <?= Captcha::display() ?><br/>
