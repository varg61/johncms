...
<div class="form-container">
    ...
    <form action="<?= Vars::$URI ?>" method="post">
        <div class="form-block">
            ...
            <span class="label label-green"><?= __('nick_available') ?></span><br/>
            <?php endif ?>
            ...
            <label for="password_confirm"><?= __('repeat_password') ?></label><br/>
            ...
            <?php endif ?>
            <label class="small"><input id="sex" type="radio" value="1" name="sex" <?= ($this->reg_data['sex'] == 1 ? 'checked="checked"' : '') ?>/>&#160;<?= Functions::loadImage('user.png') ?>&#160;<?= __('sex_m') ?></label><br/>
            <label class="small"><input type="radio" value="2" name="sex" <?= ($this->reg_data['sex'] == 2 ? 'checked="checked"' : '') ?>/>&#160;<?= Functions::loadImage('user-female.png') ?>&#160;<?= __('sex_w') ?></label>
