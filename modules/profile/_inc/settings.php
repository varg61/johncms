    ...
    default:
        ...
        */
        ...
        echo '<form action="profile.php?act=settings" method="post" >' .
            ...
            '<span style="font-weight:bold; background-color:#CCC">' . date("H:i", time() + (Vars::$SYSTEM_SET['timeshift'] + $set_user['timeshift']) * 3600) . '</span> ' . lng('system_time') .
        ...
        if (Vars::$LNG_ISO == 'ru' || Vars::$LNG_ISO == 'uk') echo '<input name="translit" type="checkbox" value="1" ' . ($set_user['translit'] ? 'checked="checked"' : '') . ' />&#160;' . lng('translit');
