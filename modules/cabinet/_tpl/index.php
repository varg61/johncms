...
<div class="menu">
    <p>
    <h3><?= Functions::getImage('mail-inbox.png') ?>&#160;<?= Vars::$LNG['my_mail'] ?></h3>
    <ul>
        <li><a href=""><?= Vars::$LNG['mail_new'] ?></a>&#160;(x)</li>
        <li><a href="pm.php"><?= Vars::$LNG['all_mail'] ?></a></li>
...
<div class="bmenu"><p>
    <h3><?= Functions::getImage('settings.png') ?>&#160;<?= Vars::$LNG['my_settings'] ?></h3>
    <ul>
        <li><a href="profile.php?act=settings"><?= Vars::$LNG['system_settings'] ?></a></li>
        <li><a href="profile.php?act=edit"><?= Vars::$LNG['profile_edit'] ?></a></li>
