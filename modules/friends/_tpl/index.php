...
<div class="topmenu">
    <a href="<?php Vars::$MODULE_URI ?>?act=demands"><?php echo lng('my_demand') ?></a> <?php echo ($this->demands ? '(<span class="red">' . $this->demands . '</span>)' : '') ?>| <a href="<?php Vars::$MODULE_URI ?>?act=offers"><?php echo lng('my_offers') ?></a> <?php echo ($this->offers ? '(<span class="red">' . $this->offers . '</span>)' : '') ?>
</div>
