...
echo'<div class="phdr"><a href="' . Vars::$HOME_URL . '/admin"><b>' . lng('admin_panel') . '</b></a> | ' . lng('downloads') . '</div>';
...
if (!isset(Vars::$SYSTEM_SET['download']) || isset($_GET['reset'])) {
    ...
    $settings = array('mod' => 1, 'theme_screen' => 1, 'top' => 25, 'icon_java' => 1, 'video_screen' => 1, 'screen_resize' => 1);
...
'<div class="menu"><p><h3><span class="green">' . lng('functions_download') . '</h3></p>'.
'<p>&nbsp;<input name="mod" type="checkbox" value="1" ' . ($settings['mod'] ? 'checked="checked"' : '') . ' />&nbsp;' . lng('set_files_mod') . '<br />'.
'&nbsp;<input name="theme_screen" type="checkbox" value="1" ' . ($settings['theme_screen'] ? 'checked="checked"' : '') . ' />&nbsp;' . lng('set_auto_screen') . '<br />'.
'&nbsp;<input name="video_screen" type="checkbox" value="1" ' . ($settings['video_screen'] ? 'checked="checked"' : '') . ' />&nbsp;' . lng('set_auto_screen_video') . '<br />'.
'&nbsp;<input name="icon_java" type="checkbox" value="1" ' . ($settings['icon_java'] ? 'checked="checked"' : '') . ' />&nbsp;' . lng('set_java_icons') . '<br />'.
'&nbsp;<input name="screen_resize" type="checkbox" value="1" ' . ($settings['screen_resize'] ? 'checked="checked"' : '') . ' />&nbsp;' . lng('set_screen_resize') . '</p>'.
'<p><h3>' . lng('set_top_files') . '</h3>&nbsp;<input type="text" size="3" maxlength="3" name="top" value="' . $settings['top'] . '" />&nbsp;(25 - 100)</p>' .
...
'<a href="' . Vars::$MODULE_URI . '">' . lng('downloads') . '</a></p>';
