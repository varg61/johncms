...
<div class="menu">
    <form action="<?= Router::getUri(3) ?>?act=edit&amp;user=<?= $this->user['id'] . '&amp;al=' . $this->al ?>" method="post">
        <div class="formblock">
            ...
            <input type="text" id="name" name="name" value="<?= Functions::checkout($this->name) ?>" maxlength="30"/><br/>
        ...
        <div class="formblock">
            ...
            <input type="text" name="password" value="<?= Functions::checkout($this->password) ?>" maxlength="15"/><br/>
