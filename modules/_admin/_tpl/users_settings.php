...
<div class="form-container">
    ...
    <form action="<?= Vars::$URI ?>" method="post">
        ...
        <div class="form-block">
            ...
            <label class="small"><input type="radio" name="flood_mode" value="1" <?= (Vars::$USER_SYS['flood_mode'] == 1 ? 'checked="checked"' : '') ?>/>&#160;<?= lng('adaptive') ?></label>
            <br/><br/>
            ...
            <label class="small"><input name="view_profiles" type="checkbox" value="1" <?= (Vars::$USER_SYS['view_profiles'] ? 'checked="checked"' : '') ?>/>&#160;<?= lng('view_profiles') ?></label>
            <br/><br/>
            <?php endif ?>
