<ul class="nav">
    ...
    <?php if (Vars::$USER_RIGHTS == 9) : ?>
        ...
        <li><a href="<?= Vars::$URI ?>?act=language_settings"><i class="icn-settings"></i><?= __('language_settings') ?><i class="icn-arrow right"></i></a></li>
    ...
    <?php endif ?>
    <li><a href="<?= Vars::$URI ?>/antispy"><i class="icn-shield"></i><?= __('antispy') ?><i class="icn-arrow right"></i></a></li>
    <?php endif ?>
</ul>