<ul class="nav">
    ...
    <li><a href="<?= $this->url ?>"><i class="icn-user-add"></i><?= __('users_reg') ?><i class="icn-arrow"></i><span class="badge badge-right"><?= $this->regTotal ?></span></a></li>
    <li><a href="<?= $this->url ?>/users_settings"><i class="icn-settings"></i><?= __('settings') ?><i class="icn-arrow right"></i></a></li>
    ...
    <li><a href="<?= $this->url ?>/links"><i class="icn-flower"></i><?= __('advertisement') ?><i class="icn-arrow right"></i></a></li>
        <?php if (Vars::$USER_RIGHTS == 9): ?>
        <li><a href="<?= $this->url ?>/counters"><i class="icn-meter"></i><?= __('counters') ?><i class="icn-arrow right"></i></a></li>
        <li><a href="<?= $this->url ?>/sitemap"><i class="icn-map"></i><?= __('sitemap') ?><i class="icn-arrow right"></i></a></li>
    ...
    <li><a href="<?= $this->url ?>/acl"><i class="icn-shield"></i><?= __('acl') ?><i class="icn-arrow right"></i></a></li>
        <?php if (Vars::$USER_RIGHTS == 9) : ?>
        <li><a href="<?= $this->url ?>/firewall"><i class="icn-shield"></i><?= __('firewall') ?><i class="icn-arrow right"></i></a></li>
        <li><a href="<?= $this->url ?>/scanner"><i class="icn-shield"></i><?= __('antispy') ?><i class="icn-arrow right"></i></a></li>
        <?php endif ?>
    <?php endif ?>
</ul>