<ul class="nav">
    ...
    <li><a href="<?= $this->uri ?>"><i class="icn-user-add"></i><?= __('users_reg') ?> /в разработке/<i class="icn-arrow"></i><span class="badge badge-right"><?= $this->regTotal ?></span></a></li>
    ...
    <li><a href="<?= Vars::$HOME_URL ?>forum/admin/"><i class="icn-comments"></i><?= __('forum') ?> /в разработке/<i class="icn-arrow right"></i></a></li>
    <li><a href="<?= Vars::$HOME_URL ?>download/admin/"><i class="icn-download"></i><?= __('downloads') ?> /в разработке/<i class="icn-arrow right"></i></a></li>
    <li><a href="<?= Vars::$HOME_URL ?>news/admin/"><i class="icn-news"></i><?= __('news') ?><i class="icn-arrow right"></i></a></li>
    <li><a href="<?= $this->uri ?>links/"><i class="icn-flower"></i><?= __('advertisement') ?> /в разработке/<i class="icn-arrow right"></i></a></li>
        <?php if (Vars::$USER_RIGHTS == 9): ?>
        <li><a href="<?= $this->uri ?>counters/"><i class="icn-meter"></i><?= __('counters') ?> /в разработке/<i class="icn-arrow right"></i></a></li>
    ...
    <li><a href="<?= $this->uri ?>acl/"><i class="icn-shield"></i><?= __('acl') ?><i class="icn-arrow right"></i></a></li>
        <?php if (Vars::$USER_RIGHTS == 9) : ?>
        <li><a href="<?= $this->uri ?>firewall/"><i class="icn-shield"></i><?= __('firewall') ?> /в разработке/<i class="icn-arrow right"></i></a></li>
