...
<div class="form-container">
    ...
    <form action="<?= Vars::$URI ?>?act=system_settings" method="post">
        <div class="form-block">
            ...
            <?php endif ?>
            <input id="timeshift" class="small<?= (isset($this->error['timeshift']) ? ' error' : '') ?>" type="text" name="timeshift" size="2" maxlength="3" value="<?= Vars::$SYSTEM_SET['timeshift'] ?>"/><span class="input-help">&#160;+-12 <?= __('hours') ?></span><br/>
            ...
            <span class="input-help"><?= __('filesize_note') ?></span><br/>
            ...
            <span class="input-help"><?= __('keywords_note') ?></span><br/>
            ...
            <span class="input-help"><?= __('description_note') ?></span><br/><br/>
