...
<table id="nav-top">
    <tr>
        ...
        <td><a href="<?= Vars::$HOME_URL ?>/users/assets" <?= (Vars::$PLACE == 'users/assets' ? 'class="select"' : '') ?> title="<?= lng('personal') ?>"><?= Functions::loadImage('toolbar-account.png', 44, '', lng('personal')) ?></a></td>
        <?php else: ?>
