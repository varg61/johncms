...
$do = array('scan_dir', 'rat', 'delmes', 'search', 'addkomm', 'komm', 'new', 'zip', 'arc', 'down', 'dfile', 'opis', 'renf', 'screen', 'ren', 'import', 'cut', 'refresh', 'upl', 'view', 'makdir', 'select', 'preview', 'delcat', 'mp3', 'trans');
if (in_array($act, $do))
{
...
} else
{
    ...
    if ($dostdmod == 1)
    {
        ...
        echo '<a href="?act=scan_dir">Обновить</a>';
        echo '</div></p>';
    }
    if (!empty($cat))
